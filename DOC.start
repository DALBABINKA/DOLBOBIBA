...
![Image text](https://i.ibb.co/L0c3Gqv/gogogo.png)
На каждый вопрос модульный ответ. Начнем с виртуальных машин.
--------------------------------------------------------------------------------
# Виртуальный машины и их работоспособность
VM для Linux
Топ:
1) VirtualBox
2) VMWare
...
Andoid: (исполняемые файлы и не только) - возня с Java настигнет нас всех.
	APK:
...
Особенности
Это реализация инструментов VMware с открытым исходным кодом. Это набор утилит виртуализации и драйверов для улучшения функциональности, пользовательского опыта и администрирования виртуальных машин VMware. Этот пакет содержит только основные программы и библиотеки пользовательского пространства.
...
# CI/CD - непрерывная интыграция и развертывания 
...
Архитектура 
Jenkins Server — установка, которая отвечает за GUI-хостинг, а также организацию и выполнение всей сборки. Jenkins Node/Slave/Build Server — устройства, которые можно настроить для выполнения работы по сборке от имени Master (главного узла). 
