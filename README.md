# BEBRAZAVRI
Главный репозиторий проекта БЕБРАЗАВРЫ КРОК
...
`git clone https://github.com/BEBRAZAVRI/BEBRAZAVRI`
...
`git remote add origin https://github.com/BEBRAZAVRI/BEBRAZAVRI.git`
